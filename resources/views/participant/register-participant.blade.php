...
<head>
  ...
  <title>Registration Participant</title>
...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="#" class="h1"><b>Meet</b>App</a>
    </div>
    <div class="card-body">
      ...
      <form action="{{ route('participant.register') }}" method="post">
        ...
        <div class="input-group mb-0">
          <input type="text" id="phone" name="phone" value="{{ old('phone') }}" class="form-control @error('phone') is-invalid @enderror" placeholder="Phone Number">
          <div class="input-group-append">
            <div class="input-group-text">
...
<!-- Bootstrap 4 -->
<script src="{{ url('assets/plugins/bootstrap/js/bootstrap.bundle.min') }}"></script>
<!-- AdminLTE App -->
